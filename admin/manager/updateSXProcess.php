    ...
    <body>
        ...
        <div style="width: 1660px;height:890px;margin-left: 240px;">
            ...
            <?php
                ...
                $sqlstr1="select * from sxprogress where id=$id";
            ...
            <div style="clear: both;margin-left:40px;position: relative;top:20px;">
                <form method="POST" action="formHandle/adminHandle/alterSXProcess.php" enctype="multipart/form-data">
                    ...
                    <input type="text" class="form-control" name="sxprocess_id" value="<?=$sxprocess_id?>"  style="width:250px;display: none;"/>
