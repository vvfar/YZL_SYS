...
<html lang="zh-CN">
    ...
    <body>
        ...
        <div style="margin-left: 180px;">
            ...
            <table class="table table-responsive table-bordered table-hover" style="margin-top: 70px;width: 1020px;margin-left: 40px;">
                <tr>
                ...
                <?php
                    ...
                    $sqlstr2="select * from files  limit ".($page-1)*$pagesize.",$pagesize";
...
<script>
    $("#createUser").click(function(){
        window.location.href="managerAddFile.php"
    })
</script>
