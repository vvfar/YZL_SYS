<?php
    ...
    if($progress==1){
        ...
        $sqlstr0="select username from user_form where department='$department' and newLevel='M级别'";
        ...
        if($fileStatus==TRUE){
            ...
            if($id==""){
                $sqlstr1="insert into sq values('$maxID'+1,'$no','$companyName','$storeName','$sqType','$pingtai','$category','$department','$input_time','$input_time2','$contract_no','$bzj','$fileAll','$re_date','KA级提交单据,M级审批单据','$username','$time')";
            }else{
                if($fileAll != ""){
                    $sqlstr1="update sq set no='$no',companyName='$companyName',storeName='$storeName',sqType='$sqType',pingTai='$pingtai',category='$category',date1='$input_time',date2='$input_time2',contractNo='$contract_no',bzj='$bzj',fileName='$fileAll',status='KA级提交单据,M级审批单据',shr='$username',shTime='$time' where id='$id'";
                }else{
                    $sqlstr1="update sq set no='$no',companyName='$companyName',storeName='$storeName',sqType='$sqType',pingTai='$pingtai',category='$category',date1='$input_time',date2='$input_time2',contractNo='$contract_no',bzj='$bzj',status='KA级提交单据,M级审批单据',shr='$username',shTime='$time' where id='$id'";
                }    
            }
        }
        ...
        $sqlstr2="select status,shr,shTime from sq where id='$id'";
