<?php
    ...
    if($progress==1){
        ...
        if($fileStatus==TRUE){
            ...
            if($id==""){
                $sqlstr1="insert into sq values('$maxID'+1,'$no','$companyName','$storeName','$sqType','$pingtai','$category','$department','$input_time','$input_time2','$contract_no','$bzj','$fileAll','$re_date','待归档','','$time')";
            }else{
                if($fileAll != ""){
