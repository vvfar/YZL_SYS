    ...
    <body>
        ...
        <div class="zhangmu_container">
            ...
            <?php
                ...
                $sqlstr3="select count(*) as total from sx_form a,hk_form b where a.sqid=b.sqid and (a.status='待生效' or a.status='待归档' or a.status='已拒绝')";
            ...
            <div style="clear:both;position: relative;top: 17px;margin-left: 30px;">
                <table class="table table-responsive table-bordered table-hover" style="width: 1020px;margin-bottom:10px;">
                    ...
                    <?php
                        ...
                        "from sx_form a,hk_form b,use_sx c where a.sqid=b.sqid and a.sqid=c.sqid and (a.status='待生效'  or a.status='待归档' or a.status='已拒绝')";
            ...
            <div style="margin-left: 30px;">
                ...
                <div style="float:left;margin-left:546px;width:321px;">
