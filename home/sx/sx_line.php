        ...
        <div style="margin-left: 180px;margin-top:50px;">
            ...
            <div style="clear: both;position:relative;top:20px;margin-left:40px;">
                ...
                <?php
                    ...
                    "b.sjhkje,b.hkfs,b.hkfs2,a.file_name,a.status,a.status2,a.allTime,a.note,a.gxDepartment,b.syjehkfs,a.bpeople ".
                        ...
                        <div style="float:right;margin-right:30px;">
                            ...
                            <?php
                                if($myrow[20]==""){
                                    ...
                                    ?>
                                    <a class="btn btn-success btn-sm" style="float:right;margin-left:10px" href="../../common/file/sx_file/<?=$myrow[20]?>" target="_blank">查看附件</a>
                                    <?php
                                }
