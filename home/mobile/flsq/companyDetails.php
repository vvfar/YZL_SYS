    ...
    <body>
        ...
        <div data-role="content" class="content">
            <form class="ui-filterable">
                <input id="myFilter4" data-type="search" style="font-size: 14px;" placeholder="查找辅料单据">
            </form>

            <ul data-role="listview" data-filter="true" data-input="#myFilter4" data-theme="g">
                <?php
                    if($department !="数据中心"){
                        $sqlstr2="select id,no,company,people,date,date2,status,allTime,'1' as tab_name from flsqd where department='$department'";
                    }else{
                        $sqlstr2="select id,no,company,people,date,date2,status,allTime,'1' as tab_name from flsqd where 1=1";
                    }
                    ...
                    $sqlstr2=$sqlstr2." union all ";

                    if($department !="数据中心"){
                        $sqlstr2=$sqlstr2."select id,no,company,people,date,date2,status,allTime,'2' as tab_name from oldflsqd where department='$department'";
                    }else{
                        $sqlstr2=$sqlstr2."select id,no,company,people,date,date2,status,allTime,'2' as tab_name from oldflsqd where 1=1";
                    }
                ...
                ?>
                <li>
                    <a href="flLine.php?id=<?=$myrow[0]?>&tab_name=<?=$tab_name?>" data-ajax="false">
