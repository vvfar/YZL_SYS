...
<html lang="zh-CN">
    ...
    <body>
        ...
        <?php
            ...
            $sqlstr3="select count(*) as total from flsqd where not status like '%已归档单据%' and not status like '%作废%' ";
            ...
            <div class="clearfix">
                ...
                <table class="table table-responsive table-bordered table-hover td1" style="margin-bottom:0px;margin-top:15px;">
                    ...
                    <?php
                        ...
                        $sqlstr2="select id,no,company,people,date,date2,status,shr from flsqd where not status like '%已归档单据%' and not status like '%作废%' ";
