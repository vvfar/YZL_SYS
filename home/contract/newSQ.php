        ...
        <div style="margin-left: 180px;">
            ...
            <div style="clear:both;margin-left:40px;">
                ...
                <form method="POST" action="../../controller/contract/SQHandle.php?option=<?=$option?>&progress=1"  enctype="multipart/form-data">
                    ...
                    <div class="form-group" style="clear: both;">
                        <span style="float: left;margin-top:20px;">上传保证金收据</span><input type="file" name="upfile" style="float: left;margin-left: 25px;margin-top:20px;"/>
                    </div>
                    <div class="form-group" style="clear: both;">
                        <span style="float: left;margin-top:20px;">上传授权扫描件</span><input type="file" name="upfile2" style="float: left;margin-left: 25px;margin-top:20px;"/>
                    </div>
                    <div class="form-group" style="clear: both;">
