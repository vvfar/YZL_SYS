    ...
    <body>
        ...
        <div style="width: 1660px;height:890px;margin-left: 240px;">
            ...
            <?php
                ...
                $sqlstr3="select count(*) as total from contract where status like '%数据中心已归档%'";
                ...
                $sqlstr2="select id,no,company,pingtai,category,department,money,sales,service,re_date,'合同',status,shr,shTime from contract where status like '%数据中心已归档%'";
...
<script>
    ...
    $("#query_contract").click(function(){
        if($("#optionID").val()=="1"){
            ...
            window.location.href="contractList.php?contractID=" +contractID + "&clientName=" + "&status=已审核";
        }else if($("#optionID").val()=="2"){
            clientName=$("#clientName").val();
            window.location.href="contractList.php?contractID=" + "&clientName=" + clientName + "&status=已审核";
        }
    })
