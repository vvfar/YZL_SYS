    ...
    <body>
        ...
        <div style="margin-left: 180px;">
            ...
            <?php
                ...
                $sqlstr3="select count(*) as total from sq where not status like '%已归档%'";
                ...
                $sqlstr2="select id,no,companyName,pingtai,category,department,bzj,'/','/',re_date,'授权',status,shr,shTime from sq where not status like '%已归档%'";
...
<script>
    ...
    $("#query_contract").click(function(){
        if($("#optionID").val()=="1"){
            sqID=$("#sqID").val();
            window.location.href="w_sq.php?sqID=" +sqID + "&clientName=" + "&status=待审核";
        }else if($("#optionID").val()=="2"){
            clientName=$("#clientName").val();
            window.location.href="w_sq.php?sqID=" + "&clientName=" + clientName + "&status=待审核";
        }
    })
