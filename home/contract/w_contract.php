    ...
    <body>
        ...
        <div style="margin-left: 180px;">
            ...
            <?php
                ...
                $sqlstr3="select count(*) as total from contract where not status like '%商务运营已归档%'";
                ...
                $sqlstr2="select id,no,company,pingtai,category,department,money,sales,service,re_date,'合同',status,shr,shTime from contract where not status like '%商务运营已归档%'";
